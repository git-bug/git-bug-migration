...
import (
	...
	"github.com/MichaelMure/git-bug-migration/migration0/repository"
	"github.com/MichaelMure/git-bug-migration/migration0/util/git"
	"github.com/MichaelMure/git-bug-migration/migration0/util/lamport"
