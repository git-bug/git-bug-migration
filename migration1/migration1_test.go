...
import (
	...
	aftertestbug "github.com/MichaelMure/git-bug-migration/migration1/after_test/bug"
	aftertestidentity "github.com/MichaelMure/git-bug-migration/migration1/after_test/identity"
	aftertestrepo "github.com/MichaelMure/git-bug-migration/migration1/after_test/repository"
	beforebug "github.com/MichaelMure/git-bug-migration/migration1/before_test/bug"
	beforerepo "github.com/MichaelMure/git-bug-migration/migration1/before_test/repository"
)
...
func TestMigrate01(t *testing.T) {
	...
	newVinc := aftertestidentity.NewIdentityFull(
		oldVinc.Name,
		oldVinc.Email,
		oldVinc.Login,
		oldVinc.AvatarUrl,
	...
	repo2, err := aftertestrepo.NewGitRepo(dir, nil)
	require.Nil(t, err, "got error when loading repository with version 2")
	...
	var bug aftertestbug.StreamedBug
