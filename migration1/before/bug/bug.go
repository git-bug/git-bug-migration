...
import (
	...
	"github.com/MichaelMure/git-bug-migration/migration1/before/repository"
	"github.com/MichaelMure/git-bug-migration/migration1/before/util/git"
	"github.com/MichaelMure/git-bug-migration/migration1/before/util/lamport"
)
